...
def tune_S2():
    ...
    for _ in [0]:
        ...
        # distill hidden layers
            ...
            if batch:
                cmd = [
                    "python", "task_distill_batch.py", "--teacher_model", teacher_dir,
                    "--student_model", student_dir,
                    "--data_dir", data_dir, "--task_name", task_name, "--output_dir", output_dir,
                    "--max_seq_length", "128", "--train_batch_size", str(tune_bs), "--learning_rate", str(tune_lr_hidden),
            ...
            cmd = [
                ...
                "--eval_step", "100",
                "--max_seq_length", "128",
                "--train_batch_size", str(tune_bs), "--log_path", log_path
            ]
